...
const ProjectsPage = () => {
	...
	const projects = [
		...
		},
		{
			...
			longDescription:
				"Personal portfolio website built with React and TailwindCSS, featuring a clean and modern design with interactive elements and responsive layout.",
					...
					<div className="grid gap-8 md:grid-cols-2">
						{filteredProjects.map((project) => (
							...
							<a href={project.liveUrl}>
								<div
									key={project.title}
									className="bg-gray-800 rounded-lg overflow-hidden border border-purple-700/30 hover:border-purple-500 transition-all"
